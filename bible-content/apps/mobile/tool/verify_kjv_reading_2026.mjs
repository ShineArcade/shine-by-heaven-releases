...
assert(payload.contentVersion === 3 && manifest.contentVersion === 3, 'content version')
...
assert(registry.requiredFullTest === true && registry.applied.length === 77, 'mandatory registry')
...
console.log(JSON.stringify({ ok: true, contentVersion: 3, books: 66, editCount: manifest.coverage.editCount, appliedRound3: registry.applied.length, pendingTerms: registry.pending.length, contentSha256: manifest.contentSha256 }, null, 2))
